...
class MNISTModel(tf.keras.Model):
    def __init__(self):
        ...
        self.conv3_b      = Conv2D(filters=128, kernel_size=[3, 3], padding='SAME', activation=tf.nn.relu)
        self.pool3_b      = MaxPool2D(padding='SAME')
    ...
    def call(self, inputs, training=False):
        ...
        net_b = self.conv3_b(net_b)
        net_b = self.pool3_b(net_b)
